...
class Sucursal(models.Model):
	...
	def fn_get_retiros(self,fecha_i,fecha_f,tipo_retiro):

		ret=Retiro_Efectivo.objects.filter(sucursal=self,fecha__range=(fecha_i,fecha_f),activo = 1,tipo_retiro__id = tipo_retiro).aggregate(Sum("importe"))
...
class Socio(models.Model):
	...
	activo = models.IntegerField(default=1)#1 es activo
...
class Retiro_Efectivo(models.Model):
	...
	activo = models.CharField(choices = SI_NO,default = 1, max_length=2)
	ocaja = models.ForeignKey(Cajas,on_delete = models.PROTECT,null = True,blank = True)
	tipo_retiro = models.ForeignKey(Tipo_Retiro,on_delete = models.PROTECT,default = 1)
...
class Token(models.Model):
	...
	aux_2 = models.IntegerField(null = True,blank = True)
